...
#define _CONCENTRATION_REPORT(GAS, _, NAME, MIXTURE, SEP, NUM) "[NAME]: [round(MIXTURE.GAS / total_moles * 100, NUM)]%[SEP]" +
#define CONCENTRATION_REPORT(MIXTURE, SEP, NUM) (APPLY_TO_GASES(_CONCENTRATION_REPORT, MIXTURE, SEP, NUM) "")

#define _SIMPLE_CONCENTRATION_REPORT(GAS, _, NAME, MIXTURE, SEP, NUM) "[(round(MIXTURE.GAS / total_moles * 100, NUM)) ? "[NAME]: [round(MIXTURE.GAS / total_moles * 100, NUM)]%[SEP]" : ""]" +
#define SIMPLE_CONCENTRATION_REPORT(MIXTURE, SEP, NUM) (APPLY_TO_GASES(_SIMPLE_CONCENTRATION_REPORT, MIXTURE, SEP, NUM) "")

#define _LIST_CONCENTRATION_REPORT(GAS, _, NAME, MIXTURE, LIST, NUM) LIST += "[NAME]: [round(MIXTURE.GAS / total_moles * 100, NUM)]%";
#define LIST_CONCENTRATION_REPORT(MIXTURE, LIST, NUM) APPLY_TO_GASES(_LIST_CONCENTRATION_REPORT, MIXTURE, LIST, NUM)
