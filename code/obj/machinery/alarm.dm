...
/obj/machinery/alarm/New()
	..()
	MAKE_SENDER_RADIO_PACKET_COMPONENT_NO_NETID("alarm", alarm_frequency)
	MAKE_SENDER_RADIO_PACKET_COMPONENT_NO_NETID("control", control_frequency) // seems to be unused?
